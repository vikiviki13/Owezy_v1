...
export function EditProfile() {
  ...
  async function save() {
    ...
    try {
      ...
      toast('Profile changes could not be saved. Please try again.');
  ...
  return (
    <SettingsPage title="Edit Profile">
      ...
      <input ref={galleryRef} type="file" accept="image/png,image/jpeg,image/webp" className="hidden" onChange={(e) => void readPhoto(e.target.files?.[0])} />
      <input ref={cameraRef} type="file" accept="image/png,image/jpeg,image/webp" capture="user" className="hidden" onChange={(e) => void readPhoto(e.target.files?.[0])} />
